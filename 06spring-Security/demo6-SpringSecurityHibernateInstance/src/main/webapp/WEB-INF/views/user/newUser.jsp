...
<div class="generic-container">
    ...
    <form:form method="POST" modelAttribute="user" class="form-horizontal" action="/user/save">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                <label class="col-md-3 control-lable" for="state">Email</label>
                <div class="col-md-7">
            ...
            <div class="form-actions floatRight">
                <c:choose>
                    <c:when test="${edit}">
                        ...
                        <a href="<c:url value='/user/list' />">Cancel</a>
                    </c:when>
                    <c:otherwise>
