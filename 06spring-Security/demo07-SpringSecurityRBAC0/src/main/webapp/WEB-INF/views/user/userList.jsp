...
<div class="pd-20">
    ...
    <table class="table table-border table-bordered table-hover table-bg table-sort">
        ...
        <tr class="text-c">
            ...
            <td><u style="cursor:pointer" class="text-primary" onclick="user_show('10001','360','','张三','user-show.html')">${user.username}</u></td>
            <%--<td>男</td>--%>
            <%--<td>13000000000</td>--%>
            <%--<td>admin@mail.com</td>--%>
            <%--<td class="text-l">北京市 海淀区</td>--%>
            <%--<td>2014-6-11 11:11:42</td>--%>
            <td class="user-status"><span class="label label-success">${user.status}</span></td>
            <td class="f-14 user-manage">
                <a style="text-decoration:none" onClick="user_stop(this,'10001')" href="javascript:;" title="停用">
                    <i class="icon-hand-down"></i></a>
